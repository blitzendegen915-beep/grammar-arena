...
export const REGULAR_QUESTIONS = [
  ...
  fill('reg27-11', 'Lesson 27', '助動詞', 'standard', 'You ought not to break your promise. You (　　　) (　　　) your promise.', "shouldn't break", 'ought not to は should not と同じ「〜すべきでない」です。'),
  ...
  fill('regplus-09', 'Plus', 'so ... as to', 'advanced', 'The man was so kind as to show me the way to the station. The man was so kind as (　　　) (　　　) me the way.', 'to show', 'so kind as to do は「親切にも〜する」です。'),
  ...
  fill('regplus-11', 'Plus', '独立不定詞', 'advanced', '(　　　) (　　　), I\'m not very good at math.', 'To begin with', 'To begin with は「まず第一に」という独立不定詞です。'),
  fill('regplus-12', 'Plus', '独立不定詞', 'advanced', 'I don\'t (　　　) (　　　) be an adult.', 'want to', 'want to do は「〜したい」です。'),
  fill('regplus-13', 'Plus', 'so as not to', 'advanced', 'Keiko is saving money so (　　　) (　　　) travel all over the world.', 'as not to', 'so as not to do は「〜しないように」です。'),
  fill('regplus-14', 'Plus', 'in order to', 'standard', 'I went to the station by taxi in order (　　　) (　　　) miss the train.', 'not to', 'in order not to do は「〜しないために」です。'),
  ...
  fill('reg16-10', 'Lesson 16', '動名詞・完了形', 'advanced', "He's ashamed of (　　　) when he was young. [make mistakes]", 'making mistakes', '過去の行為でも、文脈上明らかなときは動名詞で表します。', '', ['making mistakes', 'having made mistakes']),
  fill('reg16-11', 'Lesson 16', '動名詞・受動態', 'advanced', "I don't like (　　　) with him. [compare]", 'being compared', '受動態の動名詞は being + 過去分詞です。', '', ['being compared', 'being compared with']),
  fill('reg16-12', 'Lesson 16', '動名詞・完了形', 'advanced', 'I regret (　　　) this shirt. [buy]', 'buying', 'regret -ing は「〜したことを後悔する」です。', '', ['buying', 'having bought']),
  ...
  fill('reg17-12', 'Lesson 17', '動名詞と不定詞', 'standard', 'Do you remember (　　　) to this place often when you were small? [come]', 'coming', 'remember -ing は「〜したことを覚えている」です。'),
  fill('reg17-13', 'Lesson 17', '動名詞と不定詞', 'standard', 'Please remember (　　　) me when you arrive at the airport. [call]', 'to call', 'remember to do は「忘れずに〜する」です。'),
  fill('reg17-14', 'Lesson 17', '動名詞と不定詞', 'standard', 'She forgot (　　　) her dictionary to school. [bring]', 'bringing', 'forget -ing は「〜したことを忘れる」です。'),
  fill('reg17-15', 'Lesson 17', '動名詞と不定詞', 'standard', "I'll never forget (　　　) hands with the president. [shake]", 'shaking', 'forget -ing は過去の経験を表します。'),
  ...
  // Option 4: 名詞構文・無生物主語
  fill('regopt4-01', 'Option 4', '名詞構文', 'standard', 'Ryota runs fast. Ryota is a (　　　) (　　　).', 'fast runner', '副詞を形容詞、動詞を名詞に変えて名詞構文にします。'),
  fill('regopt4-02', 'Option 4', '名詞構文', 'standard', 'I am grateful that you accepted my invitation. I am grateful for (　　　) (　　　) of my invitation.', 'your acceptance', 'that節を所有格 + 名詞に変えます。', '', ['your acceptance', 'your accepting']),
  fill('regopt4-03', 'Option 4', '名詞構文', 'standard', 'We had no idea that he was safe. We had no idea of (　　　) (　　　).', 'his safety', '形容詞 safe を名詞 safety にします。'),
  fill('regopt4-04', 'Option 4', '名詞構文', 'standard', 'Sally decided to go to the party. Sally (　　　) a (　　　) to go to the party.', 'made a decision', 'decide を make a decision に言い換えます。'),
  fill('regopt4-05', 'Option 4', '名詞構文', 'standard', 'He was angry because the train arrived late. He was angry about the (　　　) (　　　) of the train.', 'late arrival', 'arrive を arrival に変えます。'),
  ...
  // Option 7: 前置詞
  fill('regopt7-01', 'Option 7', 'at / in / on', 'starter', 'Please pick me up (　　　) the station.', 'at', 'at は場所の一点を表します。'),
  fill('regopt7-02', 'Option 7', 'at / in / on', 'starter', 'This library closes (　　　) 9 o\'clock.', 'at', '時刻の一点には at を使います。'),
  fill('regopt7-03', 'Option 7', 'at / in / on', 'starter', 'My sister was born (　　　) July 20th.', 'on', '特定の日には on を使います。'),
  fill('regopt7-04', 'Option 7', 'at / in / on', 'starter', 'Sarah and Tom are going to get married (　　　) June.', 'in', '月・年など長さのある期間には in を使います。'),
  fill('regopt7-05', 'Option 7', 'at / in / on', 'starter', 'I put up a new clock (　　　) the wall (　　　) my room.', 'on ... in', '壁との接触面には on、部屋の内部には in を使います。', '', ['on ... in', 'on the wall in']),
